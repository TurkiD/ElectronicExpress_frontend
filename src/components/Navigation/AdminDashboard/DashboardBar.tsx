...
const DashboardBar = () => {
  return (
    <div className="container-fluid col-md-12 sticky-top">
      <div className="row">
        <div className="col-auto col-md-12 col-lg-8 min-vh-100 d-flex justify-content-between flex-column background-color">
          <div>
            <a
              href=""
            ...
            <ul className="nav nav-pills flex-column mt-3 mt-sm-0">
              <li className="nav-item text-white fs-4 my-1 py-sm-0">
                <a
                  ...
                  aria-current="page"
                >
                  <i className="fa-solid fa-home fa-xs"></i>
                  <span className="ms-3 fs-5 d-none d-sm-inline">Home</span>
                </a>
              </li>
              <li className="nav-item text-white fs-4 my-1 py-sm-0">
                <a
